...
class Helper
{
    public static function reply($comments)
    {
        foreach($comments as $comment){
            echo '<div class="comment " data-id=" '.$comment->id.' ">';
                        echo'<div class="vote">';
            ...
            if (isset($comment->reply))echo $comment->reply->count(); else echo 0; echo " replies";
            echo'</span></p></div> <div class="content-body_up"> <div class="content-body_up-title">';
            echo '<p>	'. $comment->comment .'</p><p class="reply">reply</p></div></div></div>';
